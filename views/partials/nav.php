        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="<?php if ($_SERVER['REQUEST_URI'] === '/') {echo 'bg-gray-900 text-white'; } else {echo 'text-gray-300';} ?> hover:bg-gray--700 px-3 py-2 rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
              <a href="about.php" class="hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">About</a>
